...
ShootEffect::ShootEffect(Engine::Point position, Engine::Point forwardDirection, float rotation, Turret* parent) : Sprite("play/shoot-1.png", position.x, position.y), timeTicks(0) {
	for (int i = 1; i <= 4; i++) {
